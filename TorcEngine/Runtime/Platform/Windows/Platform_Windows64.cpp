...
void Torc::Platform::Initialize(AppCreateParams* params)
{
	appParams = *params;
}
...
void Torc::Platform::GetSystemTime(SystemTime* systemTime)
{
...
const char* Torc::Platform::GetEngineRootDirectory()
{
	return ENGINE_ROOT_DIR;
}

bool Torc::Platform::SendMessageToWindow(TORC_HWND targetWindow, WindowMessage msg, void* data)
{

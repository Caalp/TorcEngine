...
public:
	...
	void Walk(float d); // forward or backward
	void Strafe(float d); // left or right
	void Pedestal(float d); // up or down

	//Rotation
	void Pitch(float angleInRadian);
	void Yaw(float angleInRadian);
	void Roll(float angleInRadian);

...
struct ImageLoadDesc
{
	...
	Torc::RHI::EResourceAccess m_usage = Torc::RHI::EResourceAccess::USAGE_GPU_READ_AND_WRITE;
	Torc::RHI::ECPUAccessFlag m_accessFlags = Torc::RHI::ECPUAccessFlag::NO_ACCESS;
	Torc::RHI::EResourceUsage m_bindFlags = Torc::RHI::EResourceUsage::BIND_SHADER_RESOURCE;

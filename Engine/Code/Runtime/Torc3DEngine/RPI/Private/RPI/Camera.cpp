...
{
	math::VectorMultiplyAndAdd(math::Vec3f{ d, d, d }, m_cameraUp, m_cameraPos, &m_cameraPos);
}

void Camera::Pitch(float angleInRadian)
{
	math::Matrix4x4f r2;
	math::RotationMatrixAroundAxis(m_cameraRight, angleInRadian, &r2);
	math::Vector3fTransformNormal(m_cameraUp, r2, &m_cameraUp);
	math::Vector3fTransformNormal(m_cameraLook, r2, &m_cameraLook);
}

void Camera::Yaw(float angleInRadian)
{
	math::Matrix4x4f r2;
	math::RotationMatrixAroundYAxis(angleInRadian, &r2);
	math::Vector3fTransformNormal(m_cameraUp, r2, &m_cameraUp);
	math::Vector3fTransformNormal(m_cameraLook, r2, &m_cameraLook);
	math::Vector3fTransformNormal(m_cameraRight, r2, &m_cameraRight);
}

void Camera::Roll(float angleInRadian)
{
	math::Matrix4x4f r2;
	math::RotationMatrixAroundZAxis(angleInRadian, &r2);
	math::Vector3fTransformNormal(m_cameraUp, r2, &m_cameraUp);
	math::Vector3fTransformNormal(m_cameraLook, r2, &m_cameraLook);
	math::Vector3fTransformNormal(m_cameraRight, r2, &m_cameraRight);
}

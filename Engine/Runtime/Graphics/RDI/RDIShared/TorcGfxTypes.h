...
namespace gfx
{
	...
	/* Blend */
	enum class TORC_GFX_BLEND_OP : uint8
	{
        ADD = 1,
        SUBTRACT = 2,
        REV_SUBTRACT = 3,
	...
	enum class TORC_GFX_BLEND : uint8
	{
        ZERO = 1,
        ONE = 2,
        SRC_COLOR = 3,
    ...
    enum class TORC_GFX_COLOR_ENABLE : uint8
    {
		NONE = 0,
        RED = 1,
        GREEN = 2,
    ...
    /* Depth */
	enum class TORC_GFX_DEPTH_WRITE : uint8
	{
		NONE,
		ALL
	};

	enum class TORC_GFX_COMPARISON_FUNC : uint8
	{
		NEVER = 0,
		LESS = 1,
		EQUAL = 2,
	...
	enum class TORC_GFX_STENCIL_OP : uint8
	{
		KEEP = 0,
		ZERO = 1,
		REPLACE = 2,
	...
	/* Rasterizer */
	enum class TORC_GFX_FILL_MODE : uint8
	{
		WIREFRAME = 0,
		SOLID,
		COUNT
	...
	enum class TORC_GFX_CULL_MODE : uint8
	{
		NONE = 0,
		FRONT,
		BACK,
	...
	/* Texture */
	enum class TORC_GFX_RESOURCE_DATA_FORMAT : uint16
	{
		FORMAT_UNKNOWN = 0,
	...
	enum class TORC_GFX_RESOURCE_USAGE : uint8
	{
	...
	typedef enum TORC_GFX_RESOURCE_BIND_FLAG : uint16
	{
	...
	enum TORC_GFX_CPU_ACCESS_FLAG : uint8
	{
		NO_ACCESS = 0,
	...
	enum class TORC_GFX_TEXTURE_ADDRESS_MODE : uint8
	{
	...
	enum class TORC_GFX_RTV_DIMENSION : uint8
	{
